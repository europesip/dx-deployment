...
**DX 9.5 CF232 – EuropeSIP Lab Cluster**
...
The OpenShift administrator must preload all required HCL DX container images into the environment's container registry.
